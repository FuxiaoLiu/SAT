...
from SAT_cross_attention_4head.model import TCP
from SAT_cross_attention_4head.config import GlobalConfig
from team_code.planner import RoutePlanner

SAVE_PATH = os.environ.get('SAVE_PATH', None)

def get_entry_point():
	return 'SAT_cross_attentionAgent'

class SAT_cross_attentionAgent(autonomous_agent.AutonomousAgent):
